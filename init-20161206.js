...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global': { range: '*', href: 'https://aaf1a18515da0e792f78-c27fdabe952dfc357fe25ebf5c8897ee.ssl.cf5.rackcdn.com/1884/style-20160525.css?v=1464177708000', containers: 1360, grid: { gutters: 40 } },
			...
			'mobile': { range: '-736', href: 'https://github.com/NSPCCDigital/Engaging-Network/blob/20161201-The-Sun-Online-Bullying/mobile-style-20161206.css', grid: { gutters: 20 }, viewport: { scalable: false } }
		}
	});
